...
import "./css/Sidebar.css"; // Giữ CSS bên trong
import { Link } from "react-router-dom"; // Import Link để navigate
...
function Sidebar({ onSelectSession }) {
  ...
  const handleNewChat = () => {
    console.log("Sidebar: Clicked AI Tìm kiếm - Reset chat and navigate to /"); // Debug
    sessionStorage.removeItem("chatHistory");
    sessionStorage.removeItem("sessionId");
    window.dispatchEvent(new Event("newChat"));
    // Navigate sẽ tự động nhờ <Link>
  };
    ...
    <aside className="sidebar" id="sidebar">
      ...
      <ul className="side-list">
        <li>
          <Link
            to="/" // Navigate về Home ("/")
            className="side-item active" // Giữ class active nếu cần CSS
            onClick={handleNewChat} // Giữ hành động reset chat
          >
            AI Tìm kiếm
          </Link>
        </li>
        ...
        {/* Các nút khác giữ <a> nếu không cần navigate */}
        <li>
          <a className="side-item" href="#">
            AI Viết văn
          </a>
              ...
              <button
                ...
                onClick={() =>
                  window.dispatchEvent(
                    new CustomEvent("selectSession", { detail: s.sessionId })
                  )
                }
              >
      ...
      <ul className="side-list">
        <li>
          <a className="side-item" href="#">
            <span className="icon-dot"></span> Tải ứng dụng
          </a>
        </li>
      </ul>
